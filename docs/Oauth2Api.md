...
> crate::models::OneOfOAuth2ClientOAuth2ClientDetail get_client(client_id, detail)
OAuth2クライアント情報を取得
...
[**crate::models::OneOfOAuth2ClientOAuth2ClientDetail**](oneOf<OAuth2Client,OAuth2ClientDetail>.md)
...
**response_type** | Option<[**crate::models::OAuth2ResponseType**](.md)> |  |  |
...
**nonce** | Option<**String**> |  |  |
**prompt** | Option<[**crate::models::OAuth2Prompt**](.md)> |  |  |
...
> revoke_o_auth2_token(post_o_auth2_revoke)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**post_o_auth2_revoke** | Option<[**PostOAuth2Revoke**](PostOAuth2Revoke.md)> |  |  |
