...
pub async fn change_user_icon(
    ...
    if local_var_status.is_success() {
        ...
        let local_var_entity: Option<ChangeUserIconError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn change_user_password(
    configuration: &configuration::Configuration,
    user_id: &str,
    put_user_password_request: Option<crate::models::PutUserPasswordRequest>,
    ...
    if local_var_status.is_success() {
        ...
        let local_var_entity: Option<ChangeUserPasswordError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn create_user(
    configuration: &configuration::Configuration,
    post_user_request: Option<crate::models::PostUserRequest>,
) -> Result<crate::models::UserDetail, Error<CreateUserError>> {
    let local_var_client = &configuration.client;
...
pub async fn edit_user(
    configuration: &configuration::Configuration,
    user_id: &str,
    patch_user_request: Option<crate::models::PatchUserRequest>,
...
pub async fn get_user(
    configuration: &configuration::Configuration,
    user_id: &str,
) -> Result<crate::models::UserDetail, Error<GetUserError>> {
    let local_var_client = &configuration.client;
...
pub async fn get_user_icon(
    configuration: &configuration::Configuration,
    user_id: &str,
) -> Result<std::path::PathBuf, Error<GetUserIconError>> {
    let local_var_client = &configuration.client;
    ...
    if local_var_status.is_success() {
        ...
        let local_var_entity: Option<GetUserIconError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_users(
...
) -> Result<Vec<crate::models::User>, Error<GetUsersError>> {
    let local_var_client = &configuration.client;
    ...
    if let Some(ref local_var_str) = include_suspended {
        local_var_req_builder =
            local_var_req_builder.query(&[("include-suspended", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_user_agent) = configuration.user_agent {
        local_var_req_builder =
            local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
