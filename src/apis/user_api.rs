...
pub async fn change_user_icon(configuration: &configuration::Configuration, user_id: &str, file: std::path::PathBuf) -> Result<(), Error<ChangeUserIconError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/users/{userId}/icon", configuration.base_path, userId=user_id);
...
pub async fn change_user_password(configuration: &configuration::Configuration, user_id: &str, put_user_password_request: Option<crate::models::PutUserPasswordRequest>) -> Result<(), Error<ChangeUserPasswordError>> {
    ...
    let local_var_uri_str = format!("{}/users/{userId}/password", configuration.base_path, userId=user_id);
    let mut local_var_req_builder = local_var_client.put(local_var_uri_str.as_str());
...
pub async fn edit_user(configuration: &configuration::Configuration, user_id: &str, patch_user_request: Option<crate::models::PatchUserRequest>) -> Result<(), Error<EditUserError>> {
    ...
    let local_var_uri_str = format!("{}/users/{userId}", configuration.base_path, userId=user_id);
...
pub async fn get_users(configuration: &configuration::Configuration, include_suspended: Option<bool>) -> Result<Vec<crate::models::User>, Error<GetUsersError>> {
