...
pub async fn activate_bot(configuration: &configuration::Configuration, bot_id: &str) -> Result<(), Error<ActivateBotError>> {
    ...
    let local_var_uri_str = format!("{}/bots/{botId}/actions/activate", configuration.base_path, botId=bot_id);
...
pub async fn change_bot_icon(configuration: &configuration::Configuration, bot_id: &str, file: std::path::PathBuf) -> Result<(), Error<ChangeBotIconError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/bots/{botId}/icon", configuration.base_path, botId=bot_id);
...
pub async fn create_bot(configuration: &configuration::Configuration, post_bot_request: Option<crate::models::PostBotRequest>) -> Result<crate::models::BotDetail, Error<CreateBotError>> {
...
pub async fn edit_bot(configuration: &configuration::Configuration, bot_id: &str, patch_bot_request: Option<crate::models::PatchBotRequest>) -> Result<(), Error<EditBotError>> {
...
pub async fn get_bot(configuration: &configuration::Configuration, bot_id: &str, detail: Option<bool>) -> Result<crate::models::OneOfBotBotDetail, Error<GetBotError>> {
...
pub async fn get_bot_logs(configuration: &configuration::Configuration, bot_id: &str, limit: Option<i32>, offset: Option<i32>) -> Result<Vec<crate::models::BotEventLog>, Error<GetBotLogsError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/bots/{botId}/logs", configuration.base_path, botId=bot_id);
    let mut local_var_req_builder = local_var_client.get(local_var_uri_str.as_str());
...
pub async fn get_bots(configuration: &configuration::Configuration, all: Option<bool>) -> Result<Vec<crate::models::Bot>, Error<GetBotsError>> {
...
pub async fn inactivate_bot(configuration: &configuration::Configuration, bot_id: &str) -> Result<(), Error<InactivateBotError>> {
    ...
    let local_var_uri_str = format!("{}/bots/{botId}/actions/inactivate", configuration.base_path, botId=bot_id);
    let mut local_var_req_builder = local_var_client.post(local_var_uri_str.as_str());
...
pub async fn let_bot_join_channel(configuration: &configuration::Configuration, bot_id: &str, post_bot_action_join_request: Option<crate::models::PostBotActionJoinRequest>) -> Result<(), Error<LetBotJoinChannelError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/bots/{botId}/actions/join", configuration.base_path, botId=bot_id);
    let mut local_var_req_builder = local_var_client.post(local_var_uri_str.as_str());
...
pub async fn let_bot_leave_channel(configuration: &configuration::Configuration, bot_id: &str, post_bot_action_leave_request: Option<crate::models::PostBotActionLeaveRequest>) -> Result<(), Error<LetBotLeaveChannelError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/bots/{botId}/actions/leave", configuration.base_path, botId=bot_id);
    let mut local_var_req_builder = local_var_client.post(local_var_uri_str.as_str());
...
pub async fn reissue_bot(configuration: &configuration::Configuration, bot_id: &str) -> Result<crate::models::BotTokens, Error<ReissueBotError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/bots/{botId}/actions/reissue", configuration.base_path, botId=bot_id);
    let mut local_var_req_builder = local_var_client.post(local_var_uri_str.as_str());
