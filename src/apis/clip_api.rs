...
pub async fn clip_message(
    ...
    folder_id: &str,
    post_clip_folder_message_request: Option<crate::models::PostClipFolderMessageRequest>,
) -> Result<crate::models::ClippedMessage, Error<ClipMessageError>> {
    ...
    if local_var_status.is_success() {
        ...
        let local_var_entity: Option<ClipMessageError> =
...
pub async fn create_clip_folder(
    configuration: &configuration::Configuration,
    post_clip_folder_request: Option<crate::models::PostClipFolderRequest>,
) -> Result<crate::models::ClipFolder, Error<CreateClipFolderError>> {
    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/clip-folders", configuration.base_path);
    let mut local_var_req_builder = local_var_client.post(local_var_uri_str.as_str());
    ...
    if local_var_status.is_success() {
        ...
        let local_var_entity: Option<CreateClipFolderError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn delete_clip_folder(
    ...
    if local_var_status.is_success() {
        ...
        let local_var_entity: Option<DeleteClipFolderError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn edit_clip_folder(
    configuration: &configuration::Configuration,
    folder_id: &str,
    patch_clip_folder_request: Option<crate::models::PatchClipFolderRequest>,
    ...
    if local_var_status.is_success() {
        ...
        let local_var_entity: Option<EditClipFolderError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_clip_folder(
    configuration: &configuration::Configuration,
    folder_id: &str,
) -> Result<crate::models::ClipFolder, Error<GetClipFolderError>> {
    let local_var_client = &configuration.client;
    ...
    if local_var_status.is_success() {
        ...
        let local_var_entity: Option<GetClipFolderError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_clip_folders(
    configuration: &configuration::Configuration,
) -> Result<Vec<crate::models::ClipFolder>, Error<GetClipFoldersError>> {
    let local_var_client = &configuration.client;
    ...
    if local_var_status.is_success() {
        ...
        let local_var_entity: Option<GetClipFoldersError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_clips(
    ...
    offset: Option<i32>,
    order: Option<&str>,
) -> Result<Vec<crate::models::ClippedMessage>, Error<GetClipsError>> {
    let local_var_client = &configuration.client;
...
pub async fn unclip_message(
    ...
    if local_var_status.is_success() {
        ...
        let local_var_entity: Option<UnclipMessageError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
