...
pub async fn get_client(
    ...
    client_id: &str,
    detail: Option<bool>,
) -> Result<crate::models::OneOfOAuth2ClientOAuth2ClientDetail, Error<GetClientError>> {
    let local_var_client = &configuration.client;
...
pub async fn get_o_auth2_authorize(
    configuration: &configuration::Configuration,
    client_id: &str,
    response_type: Option<crate::models::crate::models::OAuth2ResponseType>,
    ...
    nonce: Option<&str>,
    prompt: Option<crate::models::crate::models::OAuth2Prompt>,
...
pub async fn revoke_o_auth2_token(
    configuration: &configuration::Configuration,
    post_o_auth2_revoke: Option<crate::models::PostOAuth2Revoke>,
