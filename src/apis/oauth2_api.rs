...
/// OAuth2クライアントを作成します。
pub async fn create_client(configuration: &configuration::Configuration, post_client_request: Option<crate::models::PostClientRequest>) -> Result<crate::models::OAuth2ClientDetail, Error<CreateClientError>> {
...
pub async fn delete_client(configuration: &configuration::Configuration, client_id: &str) -> Result<(), Error<DeleteClientError>> {
    ...
    let local_var_uri_str = format!("{}/clients/{clientId}", configuration.base_path, clientId=crate::apis::urlencode(client_id));
...
pub async fn edit_client(configuration: &configuration::Configuration, client_id: &str, patch_client_request: Option<crate::models::PatchClientRequest>) -> Result<(), Error<EditClientError>> {
...
pub async fn get_client(configuration: &configuration::Configuration, client_id: &str, detail: Option<bool>) -> Result<crate::models::OneOfOAuth2ClientOAuth2ClientDetail, Error<GetClientError>> {
...
pub async fn get_clients(configuration: &configuration::Configuration, all: Option<bool>) -> Result<Vec<crate::models::OAuth2Client>, Error<GetClientsError>> {
...
pub async fn get_my_tokens(configuration: &configuration::Configuration, ) -> Result<Vec<crate::models::ActiveOAuth2Token>, Error<GetMyTokensError>> {
    ...
    let local_var_uri_str = format!("{}/users/me/tokens", configuration.base_path);
    let mut local_var_req_builder = local_var_client.get(local_var_uri_str.as_str());
...
/// OAuth2 認可エンドポイント
pub async fn get_o_auth2_authorize(configuration: &configuration::Configuration, client_id: &str, response_type: Option<crate::models::crate::models::OAuth2ResponseType>, redirect_uri: Option<&str>, scope: Option<&str>, state: Option<&str>, code_challenge: Option<&str>, code_challenge_method: Option<&str>, nonce: Option<&str>, prompt: Option<crate::models::crate::models::OAuth2Prompt>) -> Result<(), Error<GetOAuth2AuthorizeError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/oauth2/authorize", configuration.base_path);
    let mut local_var_req_builder = local_var_client.get(local_var_uri_str.as_str());
...
/// OAuth2 認可エンドポイント
pub async fn post_o_auth2_authorize(configuration: &configuration::Configuration, client_id: &str, response_type: Option<crate::models::crate::models::OAuth2ResponseType>, redirect_uri: Option<&str>, scope: Option<&str>, state: Option<&str>, code_challenge: Option<&str>, code_challenge_method: Option<&str>, nonce: Option<&str>, prompt: Option<crate::models::crate::models::OAuth2Prompt>) -> Result<(), Error<PostOAuth2AuthorizeError>> {
...
pub async fn post_o_auth2_authorize_decide(configuration: &configuration::Configuration, submit: &str) -> Result<(), Error<PostOAuth2AuthorizeDecideError>> {
    ...
    let local_var_uri_str = format!("{}/oauth2/authorize/decide", configuration.base_path);
    let mut local_var_req_builder = local_var_client.post(local_var_uri_str.as_str());
...
pub async fn revoke_my_token(configuration: &configuration::Configuration, token_id: &str) -> Result<(), Error<RevokeMyTokenError>> {
    ...
    let local_var_uri_str = format!("{}/users/me/tokens/{tokenId}", configuration.base_path, tokenId=token_id);
    let mut local_var_req_builder = local_var_client.delete(local_var_uri_str.as_str());
...
pub async fn revoke_o_auth2_token(configuration: &configuration::Configuration, post_o_auth2_revoke: Option<crate::models::PostOAuth2Revoke>) -> Result<(), Error<RevokeOAuth2TokenError>> {
    ...
    local_var_req_builder = local_var_req_builder.json(&post_o_auth2_revoke);
