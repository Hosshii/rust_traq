...
pub async fn change_webhook_icon(configuration: &configuration::Configuration, webhook_id: &str, file: std::path::PathBuf) -> Result<(), Error<ChangeWebhookIconError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/webhooks/{webhookId}/icon", configuration.base_path, webhookId=webhook_id);
...
pub async fn edit_webhook(configuration: &configuration::Configuration, webhook_id: &str, patch_webhook_request: Option<crate::models::PatchWebhookRequest>) -> Result<crate::models::Webhook, Error<EditWebhookError>> {
...
pub async fn get_webhook_messages(configuration: &configuration::Configuration, webhook_id: &str, limit: Option<i32>, offset: Option<i32>, since: Option<String>, until: Option<String>, inclusive: Option<bool>, order: Option<&str>) -> Result<Vec<crate::models::Message>, Error<GetWebhookMessagesError>> {
    ...
    let local_var_uri_str = format!("{}/webhooks/{webhookId}/messages", configuration.base_path, webhookId=webhook_id);
    let mut local_var_req_builder = local_var_client.get(local_var_uri_str.as_str());
