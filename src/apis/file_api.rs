...
pub async fn get_file_meta(
    configuration: &configuration::Configuration,
    file_id: &str,
) -> Result<crate::models::FileInfo, Error<GetFileMetaError>> {
    let local_var_client = &configuration.client;
    ...
    if local_var_status.is_success() {
        ...
        let local_var_entity: Option<GetFileMetaError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_files(
    ...
    order: Option<&str>,
    mine: Option<bool>,
) -> Result<Vec<crate::models::FileInfo>, Error<GetFilesError>> {
    let local_var_client = &configuration.client;
...
pub async fn get_thumbnail_image(
    configuration: &configuration::Configuration,
    file_id: &str,
) -> Result<std::path::PathBuf, Error<GetThumbnailImageError>> {
    let local_var_client = &configuration.client;
    ...
    if local_var_status.is_success() {
        ...
        let local_var_entity: Option<GetThumbnailImageError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
