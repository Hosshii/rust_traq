...
pub async fn create_channel(configuration: &configuration::Configuration, post_channel_request: Option<crate::models::PostChannelRequest>) -> Result<crate::models::Channel, Error<CreateChannelError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/channels", configuration.base_path);
...
pub async fn edit_channel(configuration: &configuration::Configuration, channel_id: &str, patch_channel_request: Option<crate::models::PatchChannelRequest>) -> Result<(), Error<EditChannelError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/channels/{channelId}", configuration.base_path, channelId=channel_id);
...
pub async fn edit_channel_subscribers(configuration: &configuration::Configuration, channel_id: &str, patch_channel_subscribers_request: Option<crate::models::PatchChannelSubscribersRequest>) -> Result<(), Error<EditChannelSubscribersError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/channels/{channelId}/subscribers", configuration.base_path, channelId=channel_id);
    let mut local_var_req_builder = local_var_client.patch(local_var_uri_str.as_str());
...
pub async fn edit_channel_topic(configuration: &configuration::Configuration, channel_id: &str, put_channel_topic_request: Option<crate::models::PutChannelTopicRequest>) -> Result<(), Error<EditChannelTopicError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/channels/{channelId}/topic", configuration.base_path, channelId=channel_id);
...
/// 指定したチャンネルの情報を取得します。
pub async fn get_channel(configuration: &configuration::Configuration, channel_id: &str) -> Result<crate::models::Channel, Error<GetChannelError>> {
...
pub async fn get_channel_bots(configuration: &configuration::Configuration, channel_id: &str) -> Result<Vec<crate::models::BotUser>, Error<GetChannelBotsError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/channels/{channelId}/bots", configuration.base_path, channelId=channel_id);
    let mut local_var_req_builder = local_var_client.get(local_var_uri_str.as_str());
...
pub async fn get_channel_events(configuration: &configuration::Configuration, channel_id: &str, limit: Option<i32>, offset: Option<i32>, since: Option<String>, until: Option<String>, inclusive: Option<bool>, order: Option<&str>) -> Result<Vec<crate::models::ChannelEvent>, Error<GetChannelEventsError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/channels/{channelId}/events", configuration.base_path, channelId=channel_id);
    let mut local_var_req_builder = local_var_client.get(local_var_uri_str.as_str());
...
pub async fn get_channel_pins(configuration: &configuration::Configuration, channel_id: &str) -> Result<Vec<crate::models::Pin>, Error<GetChannelPinsError>> {
    ...
    let local_var_uri_str = format!("{}/channels/{channelId}/pins", configuration.base_path, channelId=channel_id);
    let mut local_var_req_builder = local_var_client.get(local_var_uri_str.as_str());
...
pub async fn get_channel_stats(configuration: &configuration::Configuration, channel_id: &str) -> Result<crate::models::ChannelStats, Error<GetChannelStatsError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/channels/{channelId}/stats", configuration.base_path, channelId=channel_id);
    let mut local_var_req_builder = local_var_client.get(local_var_uri_str.as_str());
...
pub async fn get_channel_subscribers(configuration: &configuration::Configuration, channel_id: &str) -> Result<Vec<String>, Error<GetChannelSubscribersError>> {
...
pub async fn get_channel_topic(configuration: &configuration::Configuration, channel_id: &str) -> Result<crate::models::ChannelTopic, Error<GetChannelTopicError>> {
...
pub async fn get_channel_viewers(configuration: &configuration::Configuration, channel_id: &str) -> Result<Vec<crate::models::ChannelViewer>, Error<GetChannelViewersError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/channels/{channelId}/viewers", configuration.base_path, channelId=channel_id);
    let mut local_var_req_builder = local_var_client.get(local_var_uri_str.as_str());
...
/// チャンネルのリストを取得します。
pub async fn get_channels(configuration: &configuration::Configuration, include_dm: Option<bool>) -> Result<crate::models::ChannelList, Error<GetChannelsError>> {
...
pub async fn get_messages(configuration: &configuration::Configuration, channel_id: &str, limit: Option<i32>, offset: Option<i32>, since: Option<String>, until: Option<String>, inclusive: Option<bool>, order: Option<&str>) -> Result<Vec<crate::models::Message>, Error<GetMessagesError>> {
    ...
    let local_var_uri_str = format!("{}/channels/{channelId}/messages", configuration.base_path, channelId=channel_id);
    let mut local_var_req_builder = local_var_client.get(local_var_uri_str.as_str());
...
pub async fn get_user_dm_channel(configuration: &configuration::Configuration, user_id: &str) -> Result<crate::models::DmChannel, Error<GetUserDmChannelError>> {
    ...
    let local_var_uri_str = format!("{}/users/{userId}/dm-channel", configuration.base_path, userId=crate::apis::urlencode(user_id));
    let mut local_var_req_builder = local_var_client.get(local_var_uri_str.as_str());
...
pub async fn set_channel_subscribers(configuration: &configuration::Configuration, channel_id: &str, put_channel_subscribers_request: Option<crate::models::PutChannelSubscribersRequest>) -> Result<(), Error<SetChannelSubscribersError>> {
