...
//     post_channel_request: Option<crate::models::PostChannelRequest>,
// ) -> Result<crate::models::Channel, Error<CreateChannelError>> {
...
//     configuration: &configuration::Configuration,
//     channel_id: &str,
//     patch_channel_request: Option<crate::models::PatchChannelRequest>,
...
//         Ok(())
//     } else {
//         let local_var_entity: Option<EditChannelError> =
//             serde_json::from_str(&local_var_content).ok();
//         let local_var_error = ResponseContent {
//             status: local_var_status,
//             content: local_var_content,
...
//     configuration: &configuration::Configuration,
//     channel_id: &str,
//     put_channel_topic_request: Option<crate::models::PutChannelTopicRequest>,
...
//         Ok(())
//     } else {
//         let local_var_entity: Option<EditChannelTopicError> =
//             serde_json::from_str(&local_var_content).ok();
//         let local_var_error = ResponseContent {
//             status: local_var_status,
//             content: local_var_content,
...
//     configuration: &configuration::Configuration,
//     channel_id: &str,
// ) -> Result<crate::models::Channel, Error<GetChannelError>> {
//     let local_var_client = &configuration.client;
...
//     order: Option<&str>,
// ) -> Result<Vec<crate::models::ChannelEvent>, Error<GetChannelEventsError>> {
//     let local_var_client = &configuration.client;
...
//         serde_json::from_str(&local_var_content).map_err(Error::from)
//     } else {
//         let local_var_entity: Option<GetChannelEventsError> =
//             serde_json::from_str(&local_var_content).ok();
//         let local_var_error = ResponseContent {
//             status: local_var_status,
//             content: local_var_content,
...
//     configuration: &configuration::Configuration,
//     channel_id: &str,
// ) -> Result<Vec<crate::models::Pin>, Error<GetChannelPinsError>> {
//     let local_var_client = &configuration.client;
...
//         serde_json::from_str(&local_var_content).map_err(Error::from)
//     } else {
//         let local_var_entity: Option<GetChannelPinsError> =
//             serde_json::from_str(&local_var_content).ok();
//         let local_var_error = ResponseContent {
//             status: local_var_status,
//             content: local_var_content,
...
//     configuration: &configuration::Configuration,
//     channel_id: &str,
// ) -> Result<crate::models::ChannelStats, Error<GetChannelStatsError>> {
//     let local_var_client = &configuration.client;
...
//         serde_json::from_str(&local_var_content).map_err(Error::from)
//     } else {
//         let local_var_entity: Option<GetChannelStatsError> =
//             serde_json::from_str(&local_var_content).ok();
//         let local_var_error = ResponseContent {
//             status: local_var_status,
//             content: local_var_content,
...
//     configuration: &configuration::Configuration,
//     channel_id: &str,
// ) -> Result<crate::models::ChannelTopic, Error<GetChannelTopicError>> {
//     let local_var_client = &configuration.client;
...
//         serde_json::from_str(&local_var_content).map_err(Error::from)
//     } else {
//         let local_var_entity: Option<GetChannelTopicError> =
//             serde_json::from_str(&local_var_content).ok();
//         let local_var_error = ResponseContent {
//             status: local_var_status,
//             content: local_var_content,
...
//     configuration: &configuration::Configuration,
//     channel_id: &str,
// ) -> Result<Vec<crate::models::ChannelViewer>, Error<GetChannelViewersError>> {
//     let local_var_client = &configuration.client;
...
//         serde_json::from_str(&local_var_content).map_err(Error::from)
//     } else {
//         let local_var_entity: Option<GetChannelViewersError> =
//             serde_json::from_str(&local_var_content).ok();
//         let local_var_error = ResponseContent {
//             status: local_var_status,
//             content: local_var_content,
...
// ) -> Result<crate::models::ChannelList, Error<GetChannelsError>> {
//     let local_var_client = &configuration.client;
...
//         local_var_req_builder =
//             local_var_req_builder.query(&[("include-dm", &local_var_str.to_string())]);
//     }
//     if let Some(ref local_var_user_agent) = configuration.user_agent {
//         local_var_req_builder =
//             local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
...
//     configuration: &configuration::Configuration,
//     user_id: &str,
// ) -> Result<crate::models::DmChannel, Error<GetUserDmChannelError>> {
//     let local_var_client = &configuration.client;
...
//         serde_json::from_str(&local_var_content).map_err(Error::from)
//     } else {
//         let local_var_entity: Option<GetUserDmChannelError> =
//             serde_json::from_str(&local_var_content).ok();
//         let local_var_error = ResponseContent {
//             status: local_var_status,
//             content: local_var_content,
