...
/// 自分のアイコン画像を変更します。
pub async fn change_my_icon(configuration: &configuration::Configuration, file: std::path::PathBuf) -> Result<(), Error<ChangeMyIconError>> {
...
pub async fn read_channel(configuration: &configuration::Configuration, channel_id: &str) -> Result<(), Error<ReadChannelError>> {
    ...
    let local_var_uri_str = format!("{}/users/me/unread/{channelId}", configuration.base_path, channelId=channel_id);
...
pub async fn revoke_my_session(configuration: &configuration::Configuration, session_id: &str) -> Result<(), Error<RevokeMySessionError>> {
    ...
    let local_var_uri_str = format!("{}/users/me/sessions/{sessionId}", configuration.base_path, sessionId=session_id);
    let mut local_var_req_builder = local_var_client.delete(local_var_uri_str.as_str());
...
pub async fn set_channel_subscribe_level(configuration: &configuration::Configuration, channel_id: &str, put_channel_subscribe_level_request: Option<crate::models::PutChannelSubscribeLevelRequest>) -> Result<(), Error<SetChannelSubscribeLevelError>> {
    ...
    let local_var_uri_str = format!("{}/users/me/subscriptions/{channelId}", configuration.base_path, channelId=channel_id);
    let mut local_var_req_builder = local_var_client.put(local_var_uri_str.as_str());
