...
impl ChannelEvent {
    /// チャンネルイベント
    pub fn new(_type: Type, datetime: String, detail: crate::models::OneOfTopicChangedEventSubscribersChangedEventPinAddedEventPinRemovedEventNameChangedEventParentChangedEventVisibilityChangedEventForcedNotificationChangedEventChildCreatedEvent) -> ChannelEvent {
        ChannelEvent {
            _type,
            datetime,
            detail,
